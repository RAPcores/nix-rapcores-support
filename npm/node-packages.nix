...
let
  sources = {
    ...
    "tar-6.1.1" = {
      ...
      version = "6.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/tar/-/tar-6.1.1.tgz";
        sha512 = "GG0R7yt/CQkvG4fueXDi52Zskqxe2AyRJ+Wm54yqarnBgcX3qRIWh10qLVAAN+mlPFGTfP5UxvD3Fbi11UOTUQ==";
      };
    };
    "temp-0.9.4" = {
      name = "temp";
    ...
    "uglify-js-3.14.0" = {
      ...
      version = "3.14.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/uglify-js/-/uglify-js-3.14.0.tgz";
        sha512 = "R/tiGB1ZXp2BC+TkRGLwj8xUZgdfT2f4UZEgX6aVjJ5uttPrr4fYmwTWDGqVnBCLbOXRMY6nr/BTbwCtVfps0g==";
      };
    };
...
in
{
  ...
  "jsteros" = nodeEnv.buildNodePackage {
    ...
    src = fetchgit {
      ...
      rev = "32e8d72cc43b53ede651c817836657ee77c59673";
      sha256 = "cda5661661fe7296a0d8ca4996d4da45369c36b3bba1c76fca2c06abfc503b6d";
    };
    dependencies = [
      sources."acorn-7.4.1"
